package com.fgy.houserent.view;

import com.fgy.houserent.domain.House;
import com.fgy.houserent.service.HouseService;
import com.fgy.houserent.utility.utils;
import com.sun.media.jfxmediaimpl.HostUtils;

/**
 * 1.显示界面
 * 2.接受用户的输入
 * 3.电泳HouseService完成对房屋信息的各种操作
 * @author
 * @version 1.0
 */
public class HouseView {
    ...
    public void update() {
        ...
        String name = utils.readString(8, ""); //这里用户直接回车表示不修改该信息
        if (!"".equals(name)) {//修改
            house.setName(name);
        }
